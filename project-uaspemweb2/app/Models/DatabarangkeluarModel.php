...
class DatabarangkeluarModel extends Model
{
    protected $table = "barangkeluar";
    protected $column_order = array(null, 'faktur', 'tglfaktur', 'pelnama', null, null);
    protected $column_search = array('faktur', 'pelnama');
