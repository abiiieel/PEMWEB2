        ...
        <div class="form-group">
            ...
            <div class="input-group mb-3">
                ...
                <div class="input-group-append">
                    ...
                    <button class="btn btn-primary" type="button" id="tombolCariPelanggan" title="Cari Pelanggan">
                        <i class="fa fa-search"></i>
                    </button>
                    <button class="btn btn-warning" type="button" id="tombolTambahPelanggan" title="Tambah Pelanggan">
...
<script>
    ...
    function simpanItem() {
        ...
        if (kodebarang.length == 0) {
            Swal.fire('Error', 'Kode barang belum dimasukkan', 'error');
            kosong();
        } else {
            $.ajax({
                type: "post",
