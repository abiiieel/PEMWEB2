...
<div class="input-group mb-3">
    <input type="text" class="form-control" placeholder="Cari berdasarkan faktur" value="<?= $cari; ?>" name="cari" autofocus="true">
    ...
    <tbody>
        ...
        ?>
            <tr>
                ...
                <td>
                    <button type="button" class="btn btn-sm btn-outline-warning" title="Edit Transaksi" onclick="edit('<?= sha1($row['faktur']) ?>')">
